...
for index, K in enumerate(K_ranges):
    ...
    for user_id in all_answers_user_ids[3:5]:
        ...
        mae, mse = genome_lemmatized_recommender.get_average_mae_mse(user_id, user_movies, K=None,
                                                                     weighted=True)
        ...
        for i, t in enumerate(thresholds):
            ...
            mae, mse = lemmatized_recommenders[i].get_average_mae_mse(user_id, user_movies, K=None,
                                                                      weighted=True)
